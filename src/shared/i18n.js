export const SUPPORTED_LANGUAGES = ['en', 'pt-BR', 'ja', 'ko'];
...
const STRINGS = Object.freeze({
  en: Object.freeze({
    ...
    'onboarding.redirect': 'You will be redirected to claude.ai. Approve the request and Siphon finishes the sign-in on its own.',
    'onboarding.waitingBrowser': 'Waiting for authorization in your browser…',
    'onboarding.waitingHint': 'Approve the request on claude.ai. This window updates on its own.',
    'onboarding.waitingDeadline': 'Time limit for this sign-in: {time}',
    'onboarding.openManually': 'Browser did not open? Open this link yourself:',
    'onboarding.copyLink': 'Copy link',
    'onboarding.copied': 'Copied',
    'onboarding.hatchNotice': 'Still waiting. If you already approved it, paste the redirect URL below.',
    'onboarding.browserOpenFailed': 'Siphon could not open your browser. Copy the link below and open it yourself.',
    'onboarding.manualFallback': 'Siphon could not receive the redirect automatically. Paste the full redirect URL or the code below.',
  ...
  'pt-BR': Object.freeze({
    ...
    'onboarding.redirect': 'Você será redirecionado ao claude.ai. Autorize e o Siphon conclui o login sozinho.',
    'onboarding.waitingBrowser': 'Aguardando autorização no navegador…',
    'onboarding.waitingHint': 'Autorize o acesso no claude.ai. Esta janela se atualiza sozinha.',
    'onboarding.waitingDeadline': 'Tempo limite deste login: {time}',
    'onboarding.openManually': 'O navegador não abriu? Abra este link você mesmo:',
    'onboarding.copyLink': 'Copiar link',
    'onboarding.copied': 'Copiado',
    'onboarding.hatchNotice': 'Ainda aguardando. Se você já autorizou, cole a URL de redirecionamento abaixo.',
    'onboarding.browserOpenFailed': 'O Siphon não conseguiu abrir seu navegador. Copie o link abaixo e abra manualmente.',
    'onboarding.manualFallback': 'O Siphon não conseguiu receber o redirecionamento automaticamente. Cole a URL completa ou o código abaixo.',
  ...
  'ja': Object.freeze({
    ...
    'onboarding.redirect': 'claude.ai にリダイレクトされます。承認すると、Siphon がサインインを自動で完了します。',
    'onboarding.waitingBrowser': 'ブラウザでの承認を待っています…',
    'onboarding.waitingHint': 'claude.ai でアクセスを承認してください。このウィンドウは自動で更新されます。',
    'onboarding.waitingDeadline': 'このログインの制限時間: {time}',
    'onboarding.openManually': 'ブラウザが開きませんか？このリンクを自分で開いてください:',
    'onboarding.copyLink': 'リンクをコピー',
    'onboarding.copied': 'コピーしました',
    'onboarding.hatchNotice': 'まだ待機中です。すでに承認した場合は、リダイレクト URL を下に貼り付けてください。',
    'onboarding.browserOpenFailed': 'Siphon はブラウザを開けませんでした。下のリンクをコピーして自分で開いてください。',
    'onboarding.manualFallback': 'リダイレクトを自動で受け取れませんでした。リダイレクト URL 全体またはコードを下に貼り付けてください。',
  ...
  'ko': Object.freeze({
    'topbar.refresh': '지금 새로고침',
    'topbar.settings': '설정',
    'topbar.minimize': '최소화',
    'topbar.close': '닫기',

    'onboarding.copy.sessionStrong': '실시간 세션 할당량',
    'onboarding.copy.sessionMuted': '(Claude AI 요금제 기준)',
    'onboarding.copy.costStrong': '토큰 사용량',
    'onboarding.copy.costMuted': '(로컬 Claude Code 캐시 기준)',
    'onboarding.copy.notifyStrong': '리셋 알림',
    'onboarding.copy.notifyMuted': '새 세션이 열리는 즉시 알림을 받습니다.',
    'onboarding.cta': 'Claude AI로 로그인',
    'onboarding.redirect': 'claude.ai로 이동합니다. 승인하면 Siphon이 로그인을 자동으로 완료합니다.',
    'onboarding.waitingBrowser': '브라우저에서 승인을 기다리는 중…',
    'onboarding.waitingHint': 'claude.ai에서 액세스를 승인하세요. 이 창은 자동으로 업데이트됩니다.',
    'onboarding.waitingDeadline': '이 로그인의 제한 시간: {time}',
    'onboarding.openManually': '브라우저가 열리지 않았나요? 이 링크를 직접 여세요:',
    'onboarding.copyLink': '링크 복사',
    'onboarding.copied': '복사됨',
    'onboarding.hatchNotice': '아직 기다리는 중입니다. 이미 승인했다면 리디렉션 URL을 아래에 붙여넣으세요.',
    'onboarding.browserOpenFailed': 'Siphon이 브라우저를 열지 못했습니다. 아래 링크를 복사해 직접 여세요.',
    'onboarding.manualFallback': '리디렉션을 자동으로 받지 못했습니다. 전체 리디렉션 URL 또는 코드를 아래에 붙여넣으세요.',
    'onboarding.authTitle': '인증 코드',
    'onboarding.pasteLabel': '전체 리디렉션 URL 또는 코드를 붙여넣으세요',
    'onboarding.submit': '저장',
    'onboarding.cancel': '취소',

    'home.session': '현재 세션',
    'home.weekly': '주간 한도',
    'home.extraUsage': '추가 사용량',
    'home.today': '오늘',
    'home.month': '이번 달',
    'home.notif.on': '리셋 알림 켜짐',
    'home.notif.off': '리셋 알림 꺼짐',
    'home.costEstimate': '예상 사용 비용',
    'home.costTooltip': '로컬 Claude Code 캐시와 가격표를 기반으로 계산되었습니다. 실제 청구 금액과 다를 수 있습니다.',
    'home.peakHours': '피크 시간대',
    'home.peakHoursTooltip': 'Claude 사용량은 피크 시간대(평일, 태평양 표준시 오전 5시~11시)에 더 빨리 소진될 수 있습니다.\n현재 위치 기준으로는 오늘 {start}~{end}가 트래픽이 가장 많은 시간대입니다.',
    'pace.no_data': '데이터 없음',
    'pace.on_track': '순조로움',
    'pace.high_pace': '빠른 사용',
    'pace.likely_out': '소진 예상',
    'pace.depleted': '한도 도달',
    'tray.session': '세션',
    'tray.weekly': '주간',
    ...
    'settings.quotaMode': '백분율 표시',
    'settings.quotaModeUsed': '사용량',
    'settings.quotaModeRemaining': '남은 양',
    'settings.privacyMaskEmail': '이메일 표시 전환',

    'session.reset.empty': '메시지를 보내 시작하세요',
    'session.reset.full': '세션 한도 도달',
    'weekly.reset.empty': '메시지를 보내 시작하세요',
    'weekly.reset.full': '한도 도달',
    'reset.connector.at': '{time}에 리셋',
    'reset.connector.day': '{weekday}에 리셋',
    'reset.connector.exhausted_hourMin': '{hours}시간 {minutes}분 후인 {time}에 리셋',
    'reset.connector.exhausted_min': '{minutes}분 후인 {time}에 리셋',

    'floating.title': '현재 세션',
    'floating.refresh': '새로고침',
    'floating.close': '위젯 닫기',
    'floating.openMain': 'Siphon 열기',
    'floating.signIn': '로그인',
    'floating.error': '상태를 불러올 수 없습니다',
    'floating.expand': '위젯 펼치기',
    'floating.collapse': '위젯 접기',
    'floating.weekly': '주간',
    'floating.today': '오늘',
    'floating.month': '이번 달',

    'settings.plan': '요금제',
    'settings.planLabel': '{plan} 요금제',
    'settings.signOut': '로그아웃',
    'settings.signedInFallback': 'Claude로 로그인됨',
    'settings.title': '설정',
    ...
    'settings.languageJA': '日本語',
    'settings.languageKO': '한국어',
    'settings.section.reset': '세션 리셋 알림',
    'settings.notifReset': '알림 받기',
    'settings.sound': '소리 재생',
    'settings.testSound': '리셋 알림음 테스트',
    'settings.testSoundBtn': '테스트',
    'settings.soundVolume': '음량',
    'settings.section.limit': '70/90% 도달 알림',
    'settings.limitAlert': '알림 받기',
    'settings.limitSound': '소리 재생',
    'settings.testLimitSound': '경고 알림음 테스트',
    'settings.section.expire': '세션 만료 알림',
    'settings.expireAlert': '알림 받기',
    'settings.expireSound': '소리 재생',
    'settings.testExpireSound': '만료 알림음 테스트',
    'settings.floating': '플로팅 위젯',
    'settings.startupOpenAtLogin': 'Windows 시작 시 실행',
    'settings.startupShowWindow': '로그인 후 창 표시',
    'settings.updatesAutoCheck': '자동으로 업데이트 확인',
    'settings.updatesAutoDownload': '백그라운드에서 업데이트 다운로드',
    'settings.launchWithClaudeCode': 'Claude Code와 함께 열기',
    'settings.refreshInterval': '새로고침 간격',
    'settings.refresh30s': '30초',
    'settings.refresh1m': '1분',
    'settings.refresh5m': '5분',
    'settings.refresh15m': '15분',
    'settings.claudePath': 'Claude Code 데이터',
    'settings.editPath': '경로 수정',
    'settings.back': '뒤로',
    'settings.tabs.system': '시스템',
    'settings.tabs.notification': '알림',
    'settings.tabs.widget': '위젯',
    'settings.widget.style': '스타일',
    'settings.widget.styleClassic': '클래식',
    'settings.widget.styleMini': '알약형',

    'footer.openClaude': 'claude.ai 열기',
    'footer.quit': '종료',

    'notification.resetTitle': 'Claude 세션 리셋',
    'notification.resetBody': 'Claude 세션 한도가 초기화되어 다시 이용할 수 있습니다.',
    'notification.expireTitle': '세션 만료됨',
    'notification.expireBody': 'Claude 세션 사용량 한도에 도달했습니다.',

    'error.saveNotification': '알림 설정을 저장할 수 없습니다.',
    'error.saveFloating': '플로팅 위젯 설정을 저장할 수 없습니다.',
    'error.saveStartup': '시작 설정을 저장할 수 없습니다.',
    'error.saveLaunchWithClaudeCode': 'Claude Code 연동 설정을 업데이트할 수 없습니다.',
    ...
    'error.prefWrite': '디스크에 설정을 저장할 수 없습니다.',
    'error.claudeSettings': '저장되었으나 Claude Code 설정을 업데이트할 수 없습니다.',
    'error.unsafeUrl': '외부 링크 열기가 차단되었습니다.',

    'error.local.missing': '아직 사용량 데이터가 없습니다. Claude Code를 실행하여 데이터를 생성하세요.',
    'error.local.corrupted': '사용량 캐시가 손상되었습니다. Claude Code를 다시 시작해 보세요.',
    'error.offline.title': '인터넷에 연결되어 있지 않습니다',
    'error.offline.body': '할당량 데이터를 가져올 수 없습니다. 네트워크 연결을 확인하세요.',
    ...
    'error.scope_insufficient': '재인증이 필요합니다. 클릭하여 다시 로그인하세요.',
    ...
    'time.remaining.hourMin': '{hours}시간 {minutes}분 남음',
    'time.remaining.min': '{minutes}분 남음',
    'time.remaining.zero': '0분 남음',
    'time.days.soon': '곧 리셋',
